pipeline {
    ...
    stages {
        ...
        stage('Deploy ec2') {
            ...
            sh """
                ssh -i /var/jenkins_home/intercorp.pem -o StrictHostKeyChecking=no ubuntu@ec2-18-234-103-69.compute-1.amazonaws.com bash -c \\"sudo   docker run -d -t -p 8050:8050 --name desafio3 $registry\\"
            """
