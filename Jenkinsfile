              ...
              steps{
                ...
                stage('Deploy ec2') {
                    steps{
                            ...
                            ls /var/jenkins_home/
                            ssh -i /var/jenkins_home/intercorp.pem -o StrictHostKeyChecking=no ubuntu@ec2-18-234-103-69.compute-1.amazonaws.com bash -c \\"sudo   docker rm \\$(docker stop \\$(docker ps -a -q  --filter ancestor=$registry)) || true\\"
